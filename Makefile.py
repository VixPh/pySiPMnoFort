...
os.environ['CFLAGS']='-Ofast -funroll-all-loops -ffast-math -fopt-info -fchecking -finit-local-zero'

source = open('src/FortranFunctions.f90').read()
modulename = 'FortranFunctions'

fcompileropts = ["--opt=-Ofast -funroll-all-loops -ffast-math -fopt-info -fchecking -save-temps -fverbose-asm -finit-local-zero"]
